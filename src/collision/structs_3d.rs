...
use super::collision_fns_3d::{sphere_with_ray_collision, oriented_bounding_box_with_ray};
...
impl OrientedBoundingBox {
    ...
    pub fn check_collision_with_ray(&self, ray: Ray, instance: &Instance) -> (bool,f32) {
        ...
        (false,0.)*/
        oriented_bounding_box_with_ray(ray.origin, ray.direction, self.aabb_min, self.aabb_max, model_matrix)
    }
}
#[derive(Component,Resource)]
pub struct Ray {
